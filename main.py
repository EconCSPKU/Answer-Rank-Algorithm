...
if __name__=="__main__":
    ...
    for questionnaire in data:
        for question in questionnaire:
            ...
            output.print_heatmap(question['filename'], question['id'], question['allans'], question['guessmatrix'], order=range(len(question['allans']) - 1, -1, -1), specialname=question['specialname'] if 'specialname' in question else None, ansnum=question['ansnum'], method="original")
